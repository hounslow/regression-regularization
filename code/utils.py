...
def load_dataset(dataset_name):
    ...
    if dataset_name == "logisticData":
        data = load_pkl(os.path.join('..', DATA_DIR, 'logisticData.pkl'))
        ...
        data = load_pkl(os.path.join('..', DATA_DIR, 'multiData.pkl'))
        X, y = data['X'], data['y']
        Xvalid, yvalid = data['Xvalidate'], data['yvalidate']
        ...
        return load_pkl(os.path.join('..', DATA_DIR, dataset_name+'.pkl'))
